...
72b46efc-7515-11f1-b6da-2a4ec0f2190a:1-40,
...
INSERT INTO `evaluation_cycle_participants` VALUES ('ecp1','c1','p1','active'),('ecp2','c1','p2','active'),('ecp3','c1','p4','active'),('ecp4','c1','p3','active');
...
INSERT INTO `evaluation_cycle_raters` VALUES ('ecr1','c1','p2','u1','peer','completed'),('ecr2','c1','p2','u4','manager','pending'),('ecr3','c1','p1','u2','cross-functional','pending'),('ecr4','c1','p1','u1','self','pending'),('ecr5','c1','p4','u1','leader','pending'),('ecr6','c1','p1','u1','company','pending'),('ecr7','c1','p2','u1','client-internal','pending'),('ecr8','c1','p3','u1','client-external','pending');
...
INSERT INTO `incident_reports` VALUES ('i1','Conduta impropria em reuniao','Conduta Impropria','Conduta e Relacionamento','Em triagem','anonymous','Anonimo','Compliance','p6','RH Corporativo','2026-03-10 10:00:00','Relato de comentario inadequado em reuniao de area.'),('i2','Possivel conflito de interesse em fornecedor','Conflito de interesse','Integridade e Etica','Em apuracao','identified','Canal identificado','Compliance','p7','Compliance Corporativo','2026-03-14 15:20:00','Sinalizacao de relacionamento proximo entre colaborador e fornecedor participante de cotacao.');
...
INSERT INTO `users` VALUES ('u1','p1','colaborador1@demo.local','d3ad9315b7be5dd53b31a273b3b3aba5defe700808305aa16a3062b76658a791','employee','active',1,NULL),('u2','p2','colaborador2@demo.local','d3ad9315b7be5dd53b31a273b3b3aba5defe700808305aa16a3062b76658a791','employee','active',1,NULL),('u3','p3','consultor1@demo.local','d3ad9315b7be5dd53b31a273b3b3aba5defe700808305aa16a3062b76658a791','employee','active',1,NULL),('u4','p4','gestor@demo.local','d3ad9315b7be5dd53b31a273b3b3aba5defe700808305aa16a3062b76658a791','manager','active',1,NULL),('u5','p5','admin@demo.local','d3ad9315b7be5dd53b31a273b3b3aba5defe700808305aa16a3062b76658a791','admin','active',1,NULL),('u6','p6','rh@demo.local','d3ad9315b7be5dd53b31a273b3b3aba5defe700808305aa16a3062b76658a791','hr','active',1,NULL),('u7','p7','compliance@demo.local','d3ad9315b7be5dd53b31a273b3b3aba5defe700808305aa16a3062b76658a791','compliance','active',1,NULL),('user_zaj0pxsz','person_uqj5iyg5','homolog.onda1.1785851695@empresa.local','738aacf7ab1222d4a9a8bca1527b0534ec8398fd3e6848719e4b71792adc27db','employee','active',0,'2026-08-04 13:55:27');
...
-- Dump completed on 2026-08-04 11:27:09
