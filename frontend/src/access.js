export function getCapabilities(userOrRoleKey) {
  ...
  return {
    ...
    canManagePeopleRegistry: isAdmin || isHr || isManager,
    canViewUsersAdmin: isAdmin || isHr || isManager,
    ...
    canViewResponses: isAdmin || isHr || isManager,
    canViewPerformance360: isAdmin || isManager || isEmployee,
    canReceiveManagerFeedback: isEmployee,
    canViewEvaluationInsights: isAdmin || isHr || isManager,
