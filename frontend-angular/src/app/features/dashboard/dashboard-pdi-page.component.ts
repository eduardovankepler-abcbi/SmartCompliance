...
export class DashboardPdiPageComponent implements OnInit {
  ...
  readonly selectedResponsibleName = computed(() => this.analytics().responsibleActionSummary.find((owner) => owner.personId === this.responsibleFilter())?.personName ?? '');
  ...
  clearResponsibleFilter(): void { this.responsibleFilter.set(null); this.closeActionProgress(); }
