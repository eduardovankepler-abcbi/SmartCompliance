...
@Component({
  ...
  `,
  styles: `
    .applause{max-width:1080px}.applause__header,.error,.form-heading,.panel__heading,.card__top{display:flex;align-items:flex-start;justify-content:space-between;gap:16px}.applause__header p,.form-heading p,.panel__heading p{margin:0;color:var(--abc-blue-dark);font-size:13px;font-weight:700;text-transform:uppercase}.applause__header h1,.form-heading h2,.panel__heading h2{margin:4px 0}.applause__header span,.panel__heading>span,.state,.card p,.card__top span,.guidance span{color:var(--abc-text-muted)}button{padding:9px 12px;background:var(--abc-blue);color:var(--abc-on-blue);border:0;border-radius:var(--abc-radius);font-weight:700}.secondary{background:var(--abc-surface);color:var(--abc-text);border:1px solid var(--abc-border)}.danger{background:var(--abc-surface);color:var(--abc-danger);border:1px solid color-mix(in srgb, var(--abc-danger) 35%, var(--abc-border))}button:disabled{opacity:.6}.error{margin-top:20px;padding:12px;color:var(--abc-danger);background:color-mix(in srgb, var(--abc-danger) 8%, var(--abc-surface));border:1px solid color-mix(in srgb, var(--abc-danger) 24%, var(--abc-border));border-radius:8px}.form-panel,.metrics article,.panel,.card,.guidance{background:var(--abc-surface);border:1px solid var(--abc-border);border-radius:10px}.form-panel{margin-top:22px;padding:18px}.form-grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:14px;margin:18px 0}.form-grid label{display:grid;gap:6px;color:var(--abc-text);font-size:14px;font-weight:600}.form-grid .wide{grid-column:1/-1}.form-grid small{color:var(--abc-text-muted);font-weight:400}.guidance{display:grid;gap:6px;padding:14px;background:color-mix(in srgb, var(--abc-blue) 6%, var(--abc-surface));border-color:color-mix(in srgb, var(--abc-blue) 22%, var(--abc-border))}.guidance strong{color:var(--abc-blue-dark)}.guidance p{margin:4px 0 0;color:var(--abc-blue)}.validation{margin:0;padding:10px 12px;color:var(--abc-danger);background:color-mix(in srgb, var(--abc-danger) 8%, var(--abc-surface));border:1px solid color-mix(in srgb, var(--abc-danger) 24%, var(--abc-border));border-radius:8px}input,select,textarea{box-sizing:border-box;width:100%;padding:9px 10px;border:1px solid var(--abc-border);border-radius:var(--abc-radius);background:var(--abc-surface);color:var(--abc-text);font:inherit}.metrics{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:14px;margin-top:22px}.metrics article{display:grid;gap:4px;padding:18px}.metrics strong{font-size:26px}.metrics span{color:var(--abc-text-muted)}.panel{margin-top:20px;padding:18px}.cards{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:14px;margin-top:16px}.card{padding:16px}.card__top>div{display:grid;gap:4px}.badge{padding:4px 8px;border-radius:999px;background:color-mix(in srgb, var(--abc-blue) 8%, var(--abc-surface));color:var(--abc-blue);font-size:12px;font-weight:700}.card h3{margin:16px 0 6px}.card .impact{color:var(--abc-text);font-weight:600}.card-actions{display:flex;gap:8px;margin-top:16px}.state{margin:20px 0 4px}@media(max-width:760px){.metrics,.cards,.form-grid{grid-template-columns:1fr}.form-grid .wide{grid-column:auto}.applause__header,.panel__heading{align-items:stretch;flex-direction:column}}
  `,
})
